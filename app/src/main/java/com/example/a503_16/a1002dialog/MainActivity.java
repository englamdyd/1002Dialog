package com.example.a503_16.a1002dialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button multiselect =
                (Button)findViewById(R.id.multiselect);
        multiselect.setOnClickListener(
                new View.OnClickListener(){
                    ...
                    public void onClick(View v) {
                        new AlertDialog.Builder(MainActivity.this)
                                ...
                                .setMultiChoiceItems(R.array.player,
                                        mSelect, new DialogInterface.OnMultiChoiceClickListener() {
                                            @Override
        ...
        customdialog.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                //Anonymous 클래스에서는 자신을 포함하는 메소드의 지역변수를 사용할 수 없다. 하지만 final은 가능하다.
                ...
                new AlertDialog.Builder(MainActivity.this)
                        ...
                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int witch) {
                                ...
                                String result = "id: " + id.getText().toString() + "/passworld: " + password.getText().toString();
        ...
        popupbtn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                final PopupWindow popupWindow = new PopupWindow(popup, 600, 200, true);

                //화면 출력 - 첫번재 매개변수는 기준 뷰
                //두번째와 세번째는 좌표 네번재 포커스 여부
                popupWindow.showAtLocation(popupbtn, Gravity.NO_GRAVITY, 200, 100);
